...
function SearchComponent({ filterList, filteredCities, handleSelectCity}) {
        ...
        <>
            <div className="relative w-80 lg:w-96">
                ...
                <input
                    ...
                    value={inputValue}
                />
                <code className=" absolute end-2.5 bottom-3.5 rounded text-xs text-red-700 bg-black p-1">press enter</code>
            </div>
